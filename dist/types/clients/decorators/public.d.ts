...
export type EnsPublicActions = {
     ...
     */
    ensBatch: <TBatchFunctions extends BatchParameters>(...parameters: TBatchFunctions) => Promise<BatchReturnType<TBatchFunctions>>;
    /**
     ...
     * // TODO: real example
     */
    getAbiRecord: ({ name, gatewayUrls, strict, supportedContentTypes, }: GetAbiRecordParameters) => Promise<GetAbiRecordReturnType>;
    /**
     ...
     * // false
     */
    getAvailable: ({ name, }: GetAvailableParameters) => Promise<GetAvailableReturnType>;
    /**
     ...
     */
    getExpiry: ({ name, contract, }: GetExpiryParameters) => Promise<GetExpiryReturnType>;
    /**
     ...
     */
    getOwner: ({ name, contract, }: GetOwnerParameters) => Promise<GetOwnerReturnType>;
    /**
     ...
     */
    getPrice: ({ nameOrNames, duration, }: GetPriceParameters) => Promise<GetPriceReturnType>;
    /**
     ...
     */
    getResolver: ({ name, }: GetResolverParameters) => Promise<GetResolverReturnType>;
    /**
     ...
     */
    getWrapperData: ({ name, }: GetWrapperDataParameters) => Promise<GetWrapperDataReturnType>;
    /**
     ...
     * // wrapped.eth
     */
    getWrapperName: ({ name, }: GetWrapperNameParameters) => Promise<GetWrapperNameReturnType>;
};
/**
