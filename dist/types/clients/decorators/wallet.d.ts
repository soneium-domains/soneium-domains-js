...
export declare const ensWalletActions: <TTransport extends Transport = Transport, TChain extends ChainWithEns = ChainWithEns, TAccount extends Account | undefined = Account | undefined>(client: {
    ...
    prepareTransactionRequest: <const request extends import("viem").PrepareTransactionRequestRequest<TChain, chainOverride_1>, chainOverride_1 extends import("viem").Chain | undefined = undefined, accountOverride extends `0x${string}` | Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<TChain, TAccount, chainOverride_1, accountOverride, request>) => Promise<import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<TChain, chainOverride_1>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<TChain, chainOverride_1> extends infer T_12 ? T_12 extends import("viem").DeriveChain<TChain, chainOverride_1> ? T_12 extends import("viem").Chain ? {
        chain: T_12;
    } : {
        chain?: undefined;
    } : never : never) & (import("viem").DeriveAccount<TAccount, accountOverride> extends infer T_13 ? T_13 extends import("viem").DeriveAccount<TAccount, accountOverride> ? T_13 extends Account ? {
        account: T_13;
        from: `0x${string}`;
    } : {
        account?: undefined;
    ...
    signTransaction: <chainOverride_3 extends import("viem").Chain | undefined>(args: import("viem").SignTransactionParameters<TChain, TAccount, chainOverride_3>) => Promise<`0x02${string}` | `0x01${string}` | `0x03${string}` | import("viem").TransactionSerializedLegacy>;
