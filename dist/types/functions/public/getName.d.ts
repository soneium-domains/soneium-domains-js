...
declare const decode: (_client: ClientWithEns, data: Hex | BaseError, passthrough: GenericPassthrough, { address, allowMismatch, strict, gatewayUrls }: GetNameParameters) => Promise<GetNameReturnType | null>;
